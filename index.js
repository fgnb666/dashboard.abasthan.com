...
const UUID = process.env.UUID || 'a1f34cff-0c2d-44ae-9ac9-9b259edfe07b'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'essence-superficial-polar-bear.abasthan.app';    // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
